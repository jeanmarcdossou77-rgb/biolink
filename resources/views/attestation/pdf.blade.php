...
<div class="page">
    ...
    <div class="body">
        ...
        <div class="grade-section">
            ...
            <div class="grade-nom">{{ $grade['nom'] }}</div>
        </div>

        <div class="stats-row">
            <div class="stat-box">
                <div class="stat-num">{{ $user->publications_validees }}</div>
            ...
            <div class="stat-box">
                <div class="stat-num">{{ $user->grade_id }}/5</div>
    ...
    <div class="footer">
        ...
        <div class="footer-right">
            <div class="date-box">📅 Délivré le {{ $date }}</div>
        </div>
    </div>

    <div class="numero">
        N° BioLink-{{ str_pad($user->id, 6, '0', STR_PAD_LEFT) }}-{{ now()->format('Y') }} |
