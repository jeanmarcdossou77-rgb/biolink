...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body, html { height: 100%; overflow: hidden; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; background: #0a1628; color: white;}
        nav {
        ...
        .chat-container { flex: 1; display: flex; flex-direction: column; max-width: 800px; width: 100%; margin: 0 auto; padding: 20px; overflow: hidden; min-height: 0;}
        ...
        .messages { flex: 1; overflow-y: auto; min-height: 0; padding: 10px 0; display: flex; flex-direction: column; gap: 16px;}
        ...
        .input-area { display: flex; gap: 12px; padding: 16px; flex-shrink: 0; position: sticky; bottom: 0; background: #0a1628; border-top: 1px solid rgba(255,255,255,0.1);}
