...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Segoe UI', sans-serif; background: #0a1628; color: white; height: 100vh; overflow: hidden; display: flex; flex-direction: column; }
        nav {
        ...
        .chat-container { flex: 1; height: 100%; display: flex; flex-direction: column; max-width: 800px; width: 100%; margin: 0 auto; padding: 20px; overflow: hidden; }
        ...
        .messages { flex: 1; min-height: 0; overflow-y: auto; padding: 10px 0; display: flex; flex-direction: column; gap: 16px; }
        ...
        .input-area { display: flex; gap: 12px; padding: 16px 0; flex-shrink: 0; border-top: 1px solid rgba(255,255,255,0.1); position: sticky; bottom: 0; background: #0a1628; }
...
Notre base contient <strong>{{ \App\Models\Pathologie::where('approuve', true)->count() }}</strong> pathologies !
