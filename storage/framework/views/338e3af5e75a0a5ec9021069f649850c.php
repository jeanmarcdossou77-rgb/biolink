...
<div class="container">
    ...
    <div class="filters">
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="filter-btn"><?php echo e($cat); ?></span>
        ...
        <div class="jobs-grid">
            ...
            <div class="job-card">
                <div class="job-header">
                    <span class="job-categorie"><?php echo e($job->categorie); ?></span>
                    <span class="job-type"><?php echo e($job->type); ?></span>
                </div>
                <div class="job-titre"><?php echo e($job->titre); ?></div>
                <div class="job-entreprise">🏢 <?php echo e($job->entreprise); ?></div>
                <div class="job-lieu">📍 <?php echo e($job->lieu); ?></div>
                <div class="job-desc"><?php echo e(Str::limit($job->description, 120)); ?></div>
                <div class="job-footer">
                    <span class="job-salaire">
                        <?php echo e($job->salaire ? '💰 '.$job->salaire : '💰 Selon profil'); ?>

                    </span>
                    <a href="mailto:<?php echo e($job->email_contact); ?>" class="btn-postuler">📩 Postuler</a>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
</html><?php /**PATH C:\laragon\www\biolink\resources\views/jobs/index.blade.php ENDPATH**/ ?>