    ...
    <div class="right">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Votre nom" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="votre@email.com" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="login-link">
            Déjà membre ? <a href="<?php echo e(route('login')); ?>">Se connecter</a>
        </div>
    </div>
</div>
</body>
</html><?php /**PATH C:\laragon\www\biolink\resources\views/auth/register.blade.php ENDPATH**/ ?>