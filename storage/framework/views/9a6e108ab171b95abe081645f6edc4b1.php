        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <div class="dropdown">
                <div class="nav-link" style="cursor:pointer; gap:8px;">
                    <div class="avatar-nav"><?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?></div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\biolink\resources\views/components/navbar.blade.php ENDPATH**/ ?>