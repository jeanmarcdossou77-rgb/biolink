...
<div class="container">
    ...
    <?php if($notifications->count() > 0): ?>
        ...
        <div class="notif-card type-<?php echo e($notif->type); ?> <?php echo e(!$notif->lue ? 'non-lue' : ''); ?>">
            <div class="notif-icon">
                <?php if($notif->type === 'success'): ?> ✅
                <?php elseif($notif->type === 'warning'): ?> ⚠️
                <?php elseif($notif->type === 'grade'): ?> 🎓
                <?php else: ?> ℹ️
                <?php endif; ?>
            </div>
            <div style="flex:1">
                <div class="notif-titre">
                    <?php echo e($notif->titre); ?>

                    <?php if(!$notif->lue): ?> <span class="badge-new">NEW</span> <?php endif; ?>
                </div>
                <div class="notif-message"><?php echo e($notif->message); ?></div>
                <div class="notif-date"><?php echo e($notif->created_at->diffForHumans()); ?></div>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\biolink\resources\views/notifications/index.blade.php ENDPATH**/ ?>